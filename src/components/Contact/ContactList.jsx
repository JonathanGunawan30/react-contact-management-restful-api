    ...
    return <>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input type="text" id="search_name" name="search_name"
                                       ...
                                       placeholder="Search by name" value={name} onChange={(e) => setName(e.target.value)}/>
                            </div>
                        </div>
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input type="text" id="search_email" name="search_email"
                                       className="w-full pl-10 pr-3 py-3 bg-gray-700 bg-opacity-50 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                                       placeholder="Search by email" value={email} onChange={(e) => setEmail(e.target.value)}/>
                            </div>
                        </div>
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input type="text" id="search_phone" name="search_phone"
                                       className="w-full pl-10 pr-3 py-3 bg-gray-700 bg-opacity-50 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                                       placeholder="Search by phone" value={phone} onChange={(e) => setPhone(e.target.value)}/>
                            </div>
                        </div>
                    </div>
        ...
        <div className="mt-10 flex justify-center">
            <nav
                ...
                {page > 1 &&
                    <Link to="#" onClick={() => handlePageChange(page - 1)}
                ...
                {getPages().map(value => {
                    if(value === page){
                        return <Link to="#" onClick={() => handlePageChange(value)} key={value}
